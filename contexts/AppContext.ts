...
export const initialAppContext: IAppContext = {
  ...
  login: () => Promise.reject('login function not yet initialized'),
  register: () => Promise.reject('register function not yet initialized'),
  ...
  updateResidentRecord: () => console.warn('updateResidentRecord function not yet initialized'),
  residentRecords: [],
  ...
  bhwStats: null,
  bhwNotifications: [],
  approveIdVerification: () => console.warn('approveIdVerification not yet initialized'),
  rejectIdVerification: () => console.warn('rejectIdVerification not yet initialized'),
  patientNotifications: [],
  markPatientNotificationAsRead: () => console.warn('markPatientNotificationAsRead not yet initialized'),
  updateValidId: () => Promise.reject('updateValidId not yet initialized'),
};
